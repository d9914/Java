...
public class Test_A03_Forest {

    private void testOneGiant(Forest f, String name, String typeName, Giant other) {
        Giant p = f.createGiant(name, typeName);
        Assert.assertEquals(p.getName(), name);
        Assert.assertEquals(p.getClass(), other.getClass());
    }

    private void testGetOneGiant(Forest f, int index, Giant other) {
